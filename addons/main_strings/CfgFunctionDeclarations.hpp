// Automatically generated by 'functions_config.rb' (Sun Jun 21 18:34:19 +0100 2009)
	...
	class CBA
	{
		class Strings
		{
			...
			class formatNumber
			{
				...
				file = "\x\cba\Addons\main_strings\fnc_formatNumber.sqf";
			};
