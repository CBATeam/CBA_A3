// Automatically generated by 'functions_config.rb' (Sat Jun 20 17:58:56 +0100 2009)
	...
	class CBA
	{
		...
		class Hashes
		{
			...
			class hashGet
			{
				...
				file = "\x\cba\Addons\main\hashes_CBA_fnc_hashGet.sqf";
			};
			// CBA_fnc_hashSet
			class hashSet
			{
				description = "Sets a value for a given key in a Hash.";
				file = "\x\cba\Addons\main\hashes_CBA_fnc_hashSet.sqf";
			};
			// CBA_fnc_hashEachPair
			class hashEachPair
			{
				description = "Iterate through all keys and values in a Hash.";
				file = "\x\cba\Addons\main\hashes_CBA_fnc_hashEachPair.sqf";
			};
			// CBA_fnc_hashCreate
			class hashCreate
			{
				description = "Check if a Hash has a value defined for a key.";
				file = "\x\cba\Addons\main\hashes_CBA_fnc_hashCreate.sqf";
			};
			// CBA_fnc_isHash
			class isHash
			{
				description = "Check if a value is a Hash data structure.";
				file = "\x\cba\Addons\main\hashes_CBA_fnc_isHash.sqf";
			};
			// CBA_fnc_hashHasKey
			class hashHasKey
			{
				description = "Check if a Hash has a value defined for a key.";
				file = "\x\cba\Addons\main\hashes_CBA_fnc_hashHasKey.sqf";
			};
		};
		class Yaml
		{
