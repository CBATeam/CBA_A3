// Automatically generated by 'functions_config.rb' (Thu Jun 18 10:38:45 +0100 2009)
...
class CfgFunctions
{
	class CBA
	{
		...
		class Strings
		{
			...
			{
				description = "Formats time in seconds as ""H:MM:SS"" or ""H:MM:SS.mmm"". Intended to show time elapsed, rather than time-of-day.";
