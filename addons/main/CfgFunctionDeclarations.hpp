// Automatically generated by 'functions_config.rb' (Fri Jun 19 16:23:07 +0100 2009)
	...
	class CBA
	{
		class Misc
		{
			...
			class defaultParam
			{
				...
				file = "\x\cba\Addons\main\misc_CBA_fnc_defaultParam.sqf";
			};
			...
			class dataPath
			{
				description = "Gets value in nested Array/Hash structure.";
				file = "\x\cba\Addons\main\misc_CBA_fnc_dataPath.sqf";
			};
			// CBA_fnc_equals
			class equals
			{
		...
		class Strings
		{
			...
			class formatElapsedTime
			{
				...
				file = "\x\cba\Addons\main\strings_CBA_fnc_formatElapsedTime.sqf";
			};
			// CBA_fnc_capitalize
			class capitalize
			{
		...
		class Internal
		{
			// CBA_fnc_unitInitHandler
			class unitInitHandler
			{
				description = "Handles scripted event-handler for init events (units only)";
				file = "\x\cba\Addons\main\internal_CBA_fnc_unitInitHandler.sqf";
			};
			// CBA_fnc_vehicleInitHandler
			class vehicleInitHandler
			{
				description = "Handles scripted event-handler for init events (vehicles only)";
				file = "\x\cba\Addons\main\internal_CBA_fnc_vehicleInitHandler.sqf";
			};
		};
		class Events
		{
		...
		class Arrays
		{
			...
			class filter
			{
				...
				file = "\x\cba\Addons\main\arrays_CBA_fnc_filter.sqf";
			};
			// CBA_fnc_inject
			class inject
			{
				description = "Accumulates a value by passing elements through a function.";
				file = "\x\cba\Addons\main\arrays_CBA_fnc_inject.sqf";
			};
		};
	};
};
