...
{
	#ifdef DEBUG_MODE_FULL
	[format["Unit: %1 - Item: %2 - Item not available on Unit", _unit, _item], QUOTE(GVAR(__scriptname)), DEBUG_SETTINGS] call CBA_fnc_debug;
	#endif
	false
};
...
{
	#ifdef DEBUG_MODE_FULL
	[format["Unit: %1 - Item: %2 - Holder: %3 - Holder not object", _unit, _item, _holder], QUOTE(GVAR(__scriptname)), DEBUG_SETTINGS] call CBA_fnc_debug;
	#endif
	false
};
...
{
	#ifdef DEBUG_MODE_FULL
	[format["Unit: %1 - Item: %2 - Holder: %3 - Holder isNull", _unit, _item, _holder], QUOTE(GVAR(__scriptname)), DEBUG_SETTINGS] call CBA_fnc_debug;
	#endif
	false
};
...
#ifdef DEBUG_MODE_FULL
[format["Unit: %1 - Item: %2 - Holder: %3 - Success", _unit, _item, _holder], QUOTE(GVAR(__scriptname)), DEBUG_SETTINGS] call CBA_fnc_debug;
#endif
true
