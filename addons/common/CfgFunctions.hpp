...
class CfgFunctions
{
	class CBA
	{
		class Misc
		{
			...
			class actionArgument
			{
				...
				file = "\x\cba_a3\addons\common\fnc_actionArgument.sqf";
			};
			// CBA_fnc_addMagazine
			class addMagazine
			{
				description = "Add magazine to a vehicle/unit.";
				file = "\x\cba_a3\addons\common\fnc_addMagazine.sqf";
			};
			// CBA_fnc_addMagazineCargo
			class addMagazineCargo
			{
				description = "Add magazine(s) to a vehicle's cargo.";
				file = "\x\cba_a3\addons\common\fnc_addMagazineCargo.sqf";
			};
			...
			class addMagazineCargoGlobal
			{
				...
				file = "\x\cba_a3\addons\common\fnc_addMagazineCargoGlobal.sqf";
			};
			...
			class getGroupIndex
			{
				...
				file = "\x\cba_a3\addons\common\fnc_getGroupIndex.sqf";
			};
			// CBA_fnc_getNearest
			class getNearest
			{
				...
				file = "\x\cba_a3\addons\common\fnc_getNearest.sqf";
			};
			...
			class getNearestBuilding
			{
				...
				file = "\x\cba_a3\addons\common\fnc_getNearestBuilding.sqf";
			};
			// CBA_fnc_getPistol
			class getPistol
			{
				description = "Returns name of pistol in unit's inventory, if any.";
				file = "\x\cba_a3\addons\common\fnc_getPistol.sqf";
			};
			// CBA_fnc_getPos
			class getPos
			{
				description = "A function used to get the position of an entity.";
				file = "\x\cba_a3\addons\common\fnc_getPos.sqf";
			};
			...
			class getSharedGroup
			{
				...
				file = "\x\cba_a3\addons\common\fnc_getSharedGroup.sqf";
			};
			...
			class removeMagazineCargoGlobal
			{
				...
				file = "\x\cba_a3\addons\common\fnc_removeMagazineCargoGlobal.sqf";
			};
			...
			class removePerFrameHandler
			{
				...
				file = "\x\cba_a3\addons\common\fnc_removePerFrameHandler.sqf";
			};
			...
			class removePlayerAction
			{
				...
				file = "\x\cba_a3\addons\common\fnc_removePlayerAction.sqf";
			};
			// CBA_fnc_removeWeapon
			class removeWeapon
			{
				description = "Remove a weapon.";
				file = "\x\cba_a3\addons\common\fnc_removeWeapon.sqf";
			};
			// CBA_fnc_removeWeaponCargo
			class removeWeaponCargo
			{
				description = "Function to remove specific items from local cargo space.";
				file = "\x\cba_a3\addons\common\fnc_removeWeaponCargo.sqf";
			};
			// CBA_fnc_removeWeaponCargoGlobal
			class removeWeaponCargoGlobal
			{
				description = "Function to remove specific items from global cargo space. MP synchronized.";
				file = "\x\cba_a3\addons\common\fnc_removeWeaponCargoGlobal.sqf";
			};
	...
	class BIS {
		class variables {
			class undefCheck {
				file = "\x\cba_a3\addons\common\dummy.sqf";
			};
		};
	};
	class BIS_PMC {
