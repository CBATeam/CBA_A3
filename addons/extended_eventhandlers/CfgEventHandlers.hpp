...
fired = "_c=count _this;if(_c<6)then{_this set [_c, nearestObject[_this select 0,_this select 4]]};{_this call _x}forEach((_this select 0)getVariable'Extended_FiredEH')"; \
