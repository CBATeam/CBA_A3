...
#define EXTENDED_EVENTHANDLERS init = QUOTE(if(isnil'SLX_XEH_objects')then{call COMPILE_FILE2(extended_eventhandlers\preInit.sqf)};_this call SLX_XEH_EH_Init); \
