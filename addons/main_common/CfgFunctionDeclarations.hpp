	...
	class CBA
	{
		class Common
		{
			...
			class removeWeapon
			{
				...
				file = "\x\cba\Addons\main_common\fnc_removeWeapon.sqf";
			};
			// CBA_fnc_players
			class players
			{
				description = "Get a list of current players.";
				file = "\x\cba\Addons\main_common\fnc_players.sqf";
			};
			// CBA_fnc_createMarker
			class createMarker
			{
				description = "Creates a marker all at once.";
				file = "\x\cba\Addons\main_common\fnc_createMarker.sqf";
			};
			// CBA_fnc_addWeapon
			class addWeapon
			{
				description = "Add a weapon to a unit.";
				file = "\x\cba\Addons\main_common\fnc_addWeapon.sqf";
			};
			...
			class addMagazineVerified
			{
				...
				file = "\x\cba\Addons\main_common\fnc_addMagazineVerified.sqf";
			};
			// CBA_fnc_addMagazineCargo
			class addMagazineCargo
			{
				description = "Add magazine to a vehicle cargo.";
				file = "\x\cba\Addons\main_common\fnc_addMagazineCargo.sqf";
			};
			// CBA_fnc_isTurnedOut
			class isTurnedOut
			{
				description = "Checks whether a unit is turned out in a vehicle or not.";
				file = "\x\cba\Addons\main_common\fnc_isTurnedOut.sqf";
			};
			...
			class removeMagazine
			{
				...
				file = "\x\cba\Addons\main_common\fnc_removeMagazine.sqf";
			};
			// CBA_fnc_getPistol
			class getPistol
			{
				description = "Returns first found Pistol in unit's weaponList.";
				file = "\x\cba\Addons\main_common\fnc_getPistol.sqf";
			};
