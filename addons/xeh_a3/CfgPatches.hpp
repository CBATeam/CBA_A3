...
//			"A3Data",
			...
			"A3_Air_F_RTD",
			"A3_Air_F_RTD_Heli_Attack_01",
			"A3_Air_F_RTD_Heli_Attack_02",
			"A3_Air_F_RTD_Heli_Light_01",
			"A3_Air_F_RTD_Heli_Light_02",
			"A3_Air_F_RTD_Heli_Light_03",
			"A3_Air_F_RTD_Heli_Transport_01",
			"A3_Air_F_RTD_Heli_Transport_02",
			"A3_Air_F_Heli_Plane_CAS_02",
			"A3_Air_F_Heli_Plane_Fighter_03",
			"A3_Armor_F",
			"A3_armor_f_beta",
			"A3_Armor_F_Panther",
