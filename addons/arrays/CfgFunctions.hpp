	...
	class CBA
	{
		class Arrays
		{
			...
			class filter
			{
				...
				file = "\x\cba_a3\addons\arrays\fnc_filter.sqf";
			};
			...
			class getArrayDiff
			{
				...
				file = "\x\cba_a3\addons\arrays\fnc_getArrayDiff.sqf";
			};
			...
			class getArrayElements
			{
				...
				file = "\x\cba_a3\addons\arrays\fnc_getArrayElements.sqf";
			};
			// CBA_fnc_inject
			class inject
			{
				description = "Accumulates a value by passing elements of an array ""through"" a function.";
				file = "\x\cba_a3\addons\arrays\fnc_inject.sqf";
			};
			// CBA_fnc_join
			class join
			{
			...
			class sortNestedArray
			{
				...
				file = "\x\cba_a3\addons\arrays\fnc_sortNestedArray.sqf";
			};
			// CBA_fnc_testArrays
			class testArrays
			{
				description = "Internal Self Check. Check the RPT file for results.";
				file = "\x\cba_a3\addons\arrays\test.sqf";
			};
		};
	};
};
