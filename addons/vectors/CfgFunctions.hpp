	...
	class CBA
	{
		class Vectors
		{
			...
			class simplifyAngle
			{
				...
				file = "\x\cba_a3\addons\vectors\fnc_simplifyAngle.sqf";
			};
			...
			class simplifyAngle180
			{
				...
				file = "\x\cba_a3\addons\vectors\fnc_simplifyAngle180.sqf";
			};
			// CBA_fnc_vect2polar
			class vect2polar
			{
				description = "Parameters:";
				file = "\x\cba_a3\addons\vectors\fnc_vect2polar.sqf";
			};
			// CBA_fnc_vectAdd
			class vectAdd
			{
				description = "Returns the sum of two vectors.  Vectors can be 2D or 3D";
				file = "\x\cba_a3\addons\vectors\fnc_vectAdd.sqf";
			};
			// CBA_fnc_vectCross
			class vectCross
			{
				description = "Returns the cross product vector of two vectors.  Vectors must both be three dimensional.";
				file = "\x\cba_a3\addons\vectors\fnc_vectCross.sqf";
			};
			// CBA_fnc_vectCross2D
			class vectCross2D
			{
			...
			class vectMagn2D
			{
				...
				file = "\x\cba_a3\addons\vectors\fnc_vectMagn2D.sqf";
			};
			...
			class vectRotate2D
			{
				...
				file = "\x\cba_a3\addons\vectors\fnc_vectRotate2D.sqf";
			};
			// CBA_fnc_vectSubtract
			class vectSubtract
			{
				description = "Returns the difference of two vectors.  Vectors can be 2D or 3D.";
				file = "\x\cba_a3\addons\vectors\fnc_vectSubtract.sqf";
			};
		};
	};
};
