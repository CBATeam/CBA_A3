	...
	class CBA
	{
		class Events
		{
			...
			class removeLocalEventHandler
			{
				...
				file = "\x\cba_a3\addons\events\fnc_removeLocalEventHandler.sqf";
			};
			...
			class whereLocalEvent
			{
				...
				file = "\x\cba_a3\addons\events\fnc_whereLocalEvent.sqf";
			};
			...
			class addClientToServerEventhandler {
				...
				file = "\x\cba_a3\addons\events\fnc_addClientToServerEventhandler.sqf";
			};
			...
			class clientToServerEvent {
				...
				file = "\x\cba_a3\addons\events\fnc_clientToServerEvent.sqf";
			};
			// CBA_fnc_removeClientToServerEvent
			class removeClientToServerEvent {
				description = "Removes client to server event";
				file = "\x\cba_a3\addons\events\fnc_removeClientToServerEvent.sqf";
			};
			...
			class addReceiverOnlyEventhandler {
				...
				file = "\x\cba_a3\addons\events\fnc_addReceiverOnlyEventhandler.sqf";
			};
			...
			class receiverOnlyEvent {
				...
				file = "\x\cba_a3\addons\events\fnc_receiverOnlyEvent.sqf";
			};
			// CBA_fnc_removeReceiverOnlyEvent
			class removeReceiverOnlyEvent {
				description = "Removes receiver only event";
				file = "\x\cba_a3\addons\events\fnc_removeReceiverOnlyEvent.sqf";
			};
