	...
	class CBA
	{
		class Strings
		{
			...
			class capitalize
			{
				...
				file = "\x\cba_a3\addons\strings\fnc_capitalize.sqf";
			};
			// CBA_fnc_find
			class find
			{
				description = "Finds a string within another string.";
				file = "\x\cba_a3\addons\strings\fnc_find.sqf";
			};
			...
			class formatElapsedTime
			{
				...
				file = "\x\cba_a3\addons\strings\fnc_formatElapsedTime.sqf";
			};
