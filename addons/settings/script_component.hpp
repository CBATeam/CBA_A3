...
#define IDC_SETTING_OVERWRITE_CLIENT_TEXT 5041
#define IDC_SETTING_OVERWRITE_MISSION 5050
#define IDC_SETTING_OVERWRITE_MISSION_TEXT 5051
...
#define CAN_SET_SERVER_SETTINGS (isServer || {IS_ADMIN_LOGGED}) // in single player, as host (local server) or as logged in (not voted) admin connected to a dedicated server
