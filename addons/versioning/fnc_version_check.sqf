...
[format["%1 - Version Mismatch! (Machine: %2 (%6) version: %4, serverVersion: %3, Level: %5)", _key, player, _value, _localValue, _level, name player], QUOTE(ADDON), [true, true, true]] call CBA_fnc_debug;
