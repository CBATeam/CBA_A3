...
//#define PREP_SUB(var1,var2) PREP_SYS_SUB(PREFIX,COMPONENT_F,var1,var2); diag_log [QUOTE(DOUBLES(DOUBLES(PREFIX,COMPONENT_F),DOUBLES(fnc,var2))),'=',QUOTE(MAINPREFIX\PREFIX\SUBPREFIX\COMPONENT_F\##var1\##var2.sqf)]
